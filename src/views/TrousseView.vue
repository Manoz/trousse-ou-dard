    ...
    <div class="max-w-3xl mx-auto">
      ...
      <div class="mx-auto flex items-center justify-center my-8">
        <button
          ...
          class="rounded-md bg-primaryTrousse px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-opacity-80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primaryTrousse transition-colors duration-300"
        >
          Une autre !
        </button>
      </div>
